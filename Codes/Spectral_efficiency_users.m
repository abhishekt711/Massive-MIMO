...
a=plot(Mvalues,maxSE,'s-','LineWidth',1,'color','red');
    a.MarkerSize = 5;
    a.MarkerIndices = 1:2:length(Mvalues);
b=plot(Mvalues,maxUser,'o-','LineWidth',1,'color','blue');
    b.MarkerSize = 5;
    b.MarkerIndices = 1:2:length(Mvalues);

xlabel('Number of Antennas at BS(M)');
legend('Spectral Efficiency (bits/s/Hz/cell)','no. of users (K)','Location','NorthWest');
